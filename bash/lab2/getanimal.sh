...
#Create an array of colours, with at least 4 colours in it. Create an associative array of animals, where the keys are colours, and the values are animals who are that colour. 
...
declare -A animals
animals=(["red"]="dog" ["green"]="frog" ["blue"]="labster" ["yellow"]="canary")
